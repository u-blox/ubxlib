...
/** @file
 * @brief NRF53 simple example of how to use a library.
 */
...
static uint8_t __aligned(32) reloc_buf[256];
// make this ram part executable
K_MEM_PARTITION_DEFINE(lib_reloc, reloc_buf, sizeof(reloc_buf),
...
static void appTask(void *pParam)
{
    ...
    static struct k_mem_domain dom;
    struct k_mem_partition *app_parts[] = { &lib_reloc };
    k_mem_domain_init(&dom, ARRAY_SIZE(app_parts), app_parts);
