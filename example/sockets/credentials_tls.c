 ...
 * server.
 */
const char *const gpUEchoServerClientCertPem = "-----BEGIN CERTIFICATE-----"
 ...
 */
const char *const gpUEchoServerClientKeyPem = "-----BEGIN RSA PRIVATE KEY-----"
 ...
 */
const char *const gpUEchoServerServerCertPem = "-----BEGIN CERTIFICATE-----"
