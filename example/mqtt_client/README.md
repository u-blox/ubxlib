...
`U_CFG_APP_SHORT_RANGE_UART`: this sets the internal HW UART block that your chosen MCU will use to
talk to the short range module. If you wish to change the default value refer to [port/platform](/port/platform)
`/port/platform/<platform>/cfg/u_cfg_app_platform_specific.h`
