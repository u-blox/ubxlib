 ...
 *                       Cannot be NULL.
 * @param pHMacKey       a place to store the fixed-length
 ...
 * @param pHMacKey       a pointer to the fixed-length 16 byte
 ...
 *
 * @param cellHandle             the handle of the cellular instance.
 * @param pDeviceProfileUid      the null-terminated device profile
