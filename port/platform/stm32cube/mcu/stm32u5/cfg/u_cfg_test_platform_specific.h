 ...
 * level when executing tests on the STM32U5 platform.  NONE of the
 ...
 * user code.
 */
#define U_CFG_TEST_HEAP_MIN_FREE_BYTES (1024 * 500)
...
# define U_CFG_TEST_PIN_A         0x3f // AKA PD_15 or D9 on a NUCLEO-U575ZI-Q board
#endif
...
# define U_CFG_TEST_PIN_B         0x5c // AKA PF_12 or D8 on a NUCLEO-U575ZI-Q board
#endif
...
# define U_CFG_TEST_PIN_C         0x5f // AKA PF_15 or D2 on a NUCLEO-U575ZI-Q board
#endif
...
# define U_CFG_TEST_UART_A          0 // LPUART1
#endif
 ...
 * not -1.
 *
 * Note: the LPUART, which we pick up by setting #U_CFG_TEST_UART_A
 * to 0, _should_ have its TX output come out on the
 * NUCLEO-U575ZI-Q board as D1, PG_7, however Port G is powered
 * from VDDIO2 which has to be specifically enabled by calling
 * HAL_PWREx_EnableVddIO2(), and so instead we use PA_2.
 */
#ifndef U_CFG_TEST_PIN_UART_A_TXD
# define U_CFG_TEST_PIN_UART_A_TXD   0x02 // AKA PA_2
#endif
 ...
 *
 * Note: the LPUART, which we pick up by setting #U_CFG_TEST_UART_A
 * to 0, _should_ have its RX input on the NUCLEO-U575ZI-Q board
 * as D0, PG_8, however Port G is powered from VDDIO2 which has
 * to be specifically enabled by calling HAL_PWREx_EnableVddIO2(),
 * so to avoid having to do that we instead use PA_3.
 */
#ifndef U_CFG_TEST_PIN_UART_A_RXD
# define U_CFG_TEST_PIN_UART_A_RXD   0x03 // AKA PA_3
#endif
...
# define U_CFG_TEST_PIN_UART_A_CTS   0x06 // AKA PA_6
#endif
...
# define U_CFG_TEST_PIN_UART_A_RTS   0x11 // AKA PB_1
#endif

/** Macro to return the RTS pin for UART A: on some platforms
 * this is not a simple define.
 */
...
/** Macro to return the RTS pin for UART B: on some platforms
 * this is not a simple define.
 */
