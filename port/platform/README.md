...
- [zephyr](zephyr): we test NRF52/NRF53, STM32, NXP and also Linux/Posix for development purposes, but any MCU that is supported by Zephyr may work transparently.
