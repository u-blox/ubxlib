 ...
 * and deinitialisation, which should be called internally by the
 * porting layer initialisation/deinitialisation functions.
 */
...
#endif // _U_PORT_EVENT_QUEUE_PRIVATE_H_
